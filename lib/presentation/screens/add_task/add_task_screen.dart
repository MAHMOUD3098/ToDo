                    ...
                    child: Column(
                      children: [
                        CustomTextFormField(
                          ...
                          title: 'Title',
                          hintText: 'title',
                          validationErrorMessage: 'please enter a title !!',
                        ),
                        const SizedBox(height: 10),
                        CustomTextFormField(
                          ...
                          hintText: 'date',
                          isDateField: true,
                          validationErrorMessage: 'please choose a date !!',
                        ),
                        const SizedBox(height: 10),
                        Row(
                          children: [
                            Expanded(
                              child: CustomTextFormField(
                                ...
                                hintText: 'start time',
                                isTimeField: true,
                                validationErrorMessage: 'please choose a start date !!',
                              ),
                            ),
                            ...
                            Expanded(
                              child: CustomTextFormField(
                                ...
                                hintText: 'end time',
                                isTimeField: true,
                                validationErrorMessage: 'please choose an end start date !!',
                              ),
                            ),
                          ],
                        ),
                        ...
                        const CustomDropDownMenu(
                          ...
                          isRemindField: true,
                          validationErrorMessage: 'please choose reminder date !!',
                        ),
                        const SizedBox(height: 10),
                        const CustomDropDownMenu(
                          title: 'Repeat',
                          ...
                          isRepeatField: true,
                          validationErrorMessage: 'please choose repeat frequency!!',
                        ),
